      ...
      "groups": [
        ...
        },
        {
          ...
          "paras": [
            ...
            {
              "html": "<ul><li><b>Attorney fees</b> — a lawyer can be paid for legal work they actually did on the deal, but not a \"fee\" that's really a reward for sending the client your way.</li><li><b>Title agent fees</b> — a title company can pay its appointed agent for the real work of issuing the policy — searching the title, preparing the documents — not for the referral.</li><li><b>Loan work</b> — a lender can pay an agent or contractor who does real work on the loan: taking the application, processing it, or funding it.</li><li><b>Salary, goods &amp; office space</b> — genuine (<em>bona fide</em>) pay for actual work done, goods received, or facilities furnished at a fair price — not an inflated salary or rent that hides a kickback.</li><li><b>Agent-to-agent referrals</b> — real estate agents and brokers <em>can</em> pay each other referral fees, such as splitting a commission. But this works <em>solely between real estate agents and brokers</em> — the moment a settlement service provider (a lender, title company, or appraiser) is on either end, it's an illegal kickback again.</li><li><b>Promotional activities</b> — normal marketing and education (a lunch, a training class, branded items) is fine, as long as it isn't conditioned on referrals and doesn't pay the business expenses of someone in a position to refer.</li><li><b>Employee referrals</b> — a company can pay <em>its own</em> employees for referrals — its internal, on-payroll staff, not outside people relabeled as \"employees.\"</li></ul>"
            }
          ],
          "synth": {
